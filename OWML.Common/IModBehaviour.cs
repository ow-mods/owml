...
{
    /// <summary>The mod behaviour.</summary>
    public interface IModBehaviour
    {
        /// <summary>The ModHelper attached to this mod.</summary>
        IModHelper ModHelper { get; }

        /// <summary>The API attached to this mod.</summary>
        object Api { get; }

        /// <summary>Called whenver the config file is updated.</summary>
        ...
        /// <summary>Called on mod load to get API.</summary>
        object GetApi();
    }
}
