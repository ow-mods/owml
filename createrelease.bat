...
copy "OWML.Launcher\bin\Debug\Microsoft.Practices.Unity.dll" "Release\Microsoft.Practices.Unity.dll"
...
copy "OWML.Utils\bin\Debug\OWML.Utils.dll" "Release\OWML.Utils.dll"
copy "OWML.UnityAbstractions\bin\Debug\OWML.UnityAbstractions.dll" "Release\OWML.UnityAbstractions.dll"
...
copy "OWML.SampleMods\OWML.LoadCustomAssets\bin\Debug\config.json" "Release\Mods\OWML.LoadCustomAssets\config.json"
