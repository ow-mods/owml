...
copy "OWML.Patcher\DLLs\dnpatch.dll" "Release\dnpatch.dll"
copy "OWML.Patcher\DLLs\dnlib.dll" "Release\dnlib.dll"
copy "OWML.Patcher\DLLs\openvr_api.dll" "Release\openvr_api.dll"
copy "OWML.Patcher\DLLs\OVRPlugin.dll" "Release\OVRPlugin.dll"
