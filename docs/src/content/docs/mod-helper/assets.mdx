---
title: Assets
description: Load assets from your mod
---
...
You can use [this unity project template](https://github.com/xen-42/outer-wilds-unity-template) to make asset bundles, it includes stripped versions of all base-game scripts to make implementing base-game functionality easier.
