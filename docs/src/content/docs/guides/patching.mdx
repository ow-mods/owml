---
title: "Patching Base Game Behavior"
sidebar:
  order: 1
---
...
To examine base-game methods and figure out what you need to patch, we recommend you use [DnSpy](https://github.com/dnSpyEx/dnSpy/releases), a tool for decompiling and viewing .NET assemblies.
...
I just use `ilspy-cmd` and output the game's code to a folder for reading in my editor. Assuming you're in the game's folder:

```sh title="~/.local/share/Steam/steamapps/common/Outer Wilds"
ilspycmd -p -o "~/Documents/Outer_Wilds_Code" "OuterWilds_Data/Managed/Assembly-CSharp.dll"
```
...
<Aside title="How can we access that private field?" type="tip">
...
This about covers all the basics of patching. However, this is just the tip of the iceberg, to learn more, check out both the [Harmony](https://harmony.pardeike.net/articles/intro.html) and [HarmonyX](https://github.com/BepInEx/HarmonyX/wiki) docs.
