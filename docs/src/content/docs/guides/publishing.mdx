...
description: Publish your mod on GitHub so you can get it added to the database!
---

import { Aside, Steps } from '@astrojs/starlight/components';

This guide will give a quick overview of how to publish your mod to [the Outer Wilds mod database](https://github.com/ow-mods/ow-mod-db).

## Setting Up A GitHub Repo

To get started, you'll want to [create a GitHub account](https://github.com/signup) and grab [GitHub Desktop](https://desktop.github.com/).
...
<Aside>
It might alert you that there isn't a repo there, just click the small link that says "create a repository here".
</Aside>
...
This file format is called [Markdown](https://www.markdownguide.org/), it's a very simple way to write content for websites. If you don't know markdown you can use [this tutorial](https://www.markdowntutorial.com/) to help you. Make sure your README gives a good description of your mod!
