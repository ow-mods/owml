...
description: Make your mod configurable via the settings menu
---
...
```json title="default-config.json" ins={4-6}
{
...
```json title="default-config.json" ins={5}
{
    "$schema": "https://raw.githubusercontent.com/ow-mods/owml/master/schemas/config_schema.json",
    "enabled": true,
    "settings": {
...
```json title="default-config.json" ins={5-6}
{
    "$schema": "https://raw.githubusercontent.com/ow-mods/owml/master/schemas/config_schema.json",
    "enabled": true,
    "settings": {
...
```json title="default-config.json" ins={5-14}
{
    "$schema": "https://raw.githubusercontent.com/ow-mods/owml/master/schemas/config_schema.json",
    "enabled": true,
    "settings": {
...
```json title="default-config.json" ins={5-10}
{
    "$schema": "https://raw.githubusercontent.com/ow-mods/owml/master/schemas/config_schema.json",
    "enabled": true,
    "settings": {
...
```json title="default-config.json" ins={6-8}
{
    "$schema": "https://raw.githubusercontent.com/ow-mods/owml/master/schemas/config_schema.json",
    "enabled": true,
    "settings": {
...
<Aside type="tip" title="Config Schema">
...
Now that we have these values defined, we can use [`ModHelper.Config.GetSettingsValue`](/mod-helper/config#getsettingvaluet) to grab our options.

```csharp title="MyMod.cs"
...
```json title="translations/english.json"
{
    "UIDictionary": {
