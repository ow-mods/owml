---
title: Prepatchers
description: Perform patches before the game starts
---
...
```json title="manifest.json" ins={8}
{
  "filename": "MyPrepatcher.dll",
  "author": "Me",
  "name": "My cool mod",
  "uniqueName": "Bwc9876.MyMod",
  "version": "0.0.1",
  "owmlVersion": "2.9.0",
  "prepatcher": "MyPrepatcher.exe"
}
```
...
<Aside type="caution" title="Prepatchers are permanent">
...
is disabled or uninstalled, the manager will show a dialog explaining that your mod has modified game files in an irreversible way and encourages them to validate the game files.
</Aside>
