...
namespace OWML.ModHelper.Menus
{
    public class ModMenus : IModMenus
    {
        ...
        public ModMenus(IModConsole console, IModEvents events, IModInputHandler inputHandler, IModManifest owmlManifest, IOwmlConfig owmlConfig)
        {
            MainMenu = new ModMainMenu(console);
            PauseMenu = new ModPauseMenu(console);
            ModsMenu = new ModsMenu(console, this, inputHandler);
            OwmlMenu = new OwmlConfigMenu(console, owmlManifest, owmlConfig);
